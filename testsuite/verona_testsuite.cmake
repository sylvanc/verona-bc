...
function(testsuite name)
  ...
  foreach(test_collection ${test_collections})
    ...
    unset(TESTSUITE_REQUIRE_BASENAME_MATCH_PARENT_DIR)
    ...
    if(TESTSUITE_REQUIRE_BASENAME_MATCH_PARENT_DIR)
      set(filtered_tests)
      foreach(test ${tests})
        get_filename_component(test_dir ${test} DIRECTORY)
        get_filename_component(test_name ${test} NAME_WE)
        get_filename_component(test_dir_name ${test_dir} NAME)
        if(test_name STREQUAL test_dir_name)
          list(APPEND filtered_tests ${test})
        endif()
      endforeach()
      set(tests ${filtered_tests})
    endif()
